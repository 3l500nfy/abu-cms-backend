...
<head>
    ...
    <title>ABU CMS - Manage Complaints</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content p-0">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        <h5 class="mb-0">Manage Complaints</h5>
                ...
                <div class="p-4">
                            ...
                            <form method="GET" class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('admin.complaints') }}" class="btn btn-outline-secondary">Clear</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <small class="text-muted">
                                                    ...
                                                    <strong>Assigned to:</strong> {{ $complaint->department ? $complaint->department->name : 'Unassigned' }}<br>
                                    ...
                                    <div class="col-md-4">
                                        <form method="POST" action="{{ route('admin.complaints.update-status', $complaint->id) }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <textarea name="resolution_notes" class="form-control form-control-sm" rows="2" placeholder="Add resolution notes...">{{ $complaint->resolution_notes }}</textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary btn-sm w-100 mb-2">Update Status</button>
                                        </form>
                                        
                                        <!-- Delete Complaint Button -->
                                        <button type="button" class="btn btn-danger btn-sm w-100" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $complaint->id }}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteModalLabel{{ $complaint->id }}">Confirm Delete</h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.complaints.delete', $complaint->id) }}" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">There are no complaints matching your criteria.</p>
                        </div>
                    @endif
                </div>
            </div>
